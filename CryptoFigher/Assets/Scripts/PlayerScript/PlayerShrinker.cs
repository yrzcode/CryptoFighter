...
[RequireComponent(typeof(PlayerPunk))]
public class PlayerShrinker : MonoBehaviour
{
    [SerializeField] GameObject containerShrinker;
    ...
    {
        containerShrinker.transform.localScale = currentPlayerLocalScale;
    }
    ...
    private IEnumerator PlayerRunShrink()
    {
        ...
        {
            containerShrinker.transform.localScale =
    new Vector3(containerShrinker.transform.localScale.x,
                shrinkAmout,
                containerShrinker.transform.localScale.z);
            yield return null;
        }
